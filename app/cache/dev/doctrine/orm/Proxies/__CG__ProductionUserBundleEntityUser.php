...
namespace Proxies\__CG__\Production\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Production\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Production\\UserBundle\\Entity\\User' . "\0" . 'family_name', '' . "\0" . 'Production\\UserBundle\\Entity\\User' . "\0" . 'first_name', '' . "\0" . 'Production\\UserBundle\\Entity\\User' . "\0" . 'etapeUtilisateur', '' . "\0" . 'Production\\UserBundle\\Entity\\User' . "\0" . 'tel', 'created', 'lastActivity', '' . "\0" . 'Production\\UserBundle\\Entity\\User' . "\0" . 'image', '' . "\0" . 'Production\\UserBundle\\Entity\\User' . "\0" . 'service', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function isActiveNow()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isActiveNow', array());
    ...
    public function getEtapeUtilisateur()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEtapeUtilisateur', array());

        return parent::getEtapeUtilisateur();
    }
    ...
    public function setEtapeUtilisateur($etapeUtilisateur)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEtapeUtilisateur', array($etapeUtilisateur));

        return parent::setEtapeUtilisateur($etapeUtilisateur);
    }
