 ...
 */
class Workflow extends \Production\ProductionBundle\Entity\Workflow implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Production\\ProductionBundle\\Entity\\Workflow' . "\0" . 'id', '' . "\0" . 'Production\\ProductionBundle\\Entity\\Workflow' . "\0" . 'titre', '' . "\0" . 'Production\\ProductionBundle\\Entity\\Workflow' . "\0" . 'cart', '' . "\0" . 'Production\\ProductionBundle\\Entity\\Workflow' . "\0" . 'carts', '' . "\0" . 'Production\\ProductionBundle\\Entity\\Workflow' . "\0" . 'description');
        }
