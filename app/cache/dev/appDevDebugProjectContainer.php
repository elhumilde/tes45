...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Production\UserBundle\Stats\StatsHandler A Production\UserBundle\Stats\StatsHandler instance.
     */
    protected function getBen_StatsHandlerService()
    {
        return $this->services['ben.stats_handler'] = new \Production\UserBundle\Stats\StatsHandler($this->get('doctrine.orm.default_entity_manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Production\ProductionBundle\Twig\ConfigExtension A Production\ProductionBundle\Twig\ConfigExtension instance.
     */
    protected function getBen_Twig_Extension_ConfigService()
    {
        return $this->services['ben.twig.extension.config'] = new \Production\ProductionBundle\Twig\ConfigExtension($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'production', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Production\\ProductionBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Production\\UserBundle\\Entity')));
        ...
        $d->addDriver($b, 'Production\\ProductionBundle\\Entity');
        $d->addDriver($b, 'Production\\UserBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('ProductionBundle' => 'Production\\ProductionBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'UserBundle' => 'Production\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3c88526c3470ff26c65e616af247c441366dbe9bad76c35afd0c12652821cc4b');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('fayssal1anouar@gmail.com' => 'admin'), 'resetting' => array('fayssal1anouar@gmail.com' => 'admin'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Production\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Production\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Production\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_PublicService()
    {
        ...
        $l = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), 'ThisTokenIsNotSoSecretChangeIt', 'public', array('lifetime' => 604800, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($c, $k, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($k, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $m->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $m->addHandler($l);

        $n = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($k, array('login_path' => 'fos_user_security_login', 'default_target_path' => '/', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $n->setProviderKey('public');

        $o = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($c, $g, $this->get('security.authentication.session_strategy'), $k, 'public', $n, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $k, array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $o->setRememberMeServices($l);

        return $this->services['security.firewall.map.context.public'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($c, array(0 => new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $b)), 1 => $b), 'public', $a, $d), 2 => $m, 3 => $o, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($c, $l, $g, $a, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($c, '5a6852fd0d2f6', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($c, $this->get('security.access.decision_manager'), $j, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($c, $this->get('security.authentication.trust_resolver'), $k, 'public', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $k, 'fos_user_security_login', false), NULL, NULL, $a));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Production\\ProductionBundle/Resources/views'), 'Production');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Production\\UserBundle/Resources/views'), 'User');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_INFORMATION' => array(0 => 'ROLE_USER'), 'ROLE_COMMERCIAL' => array(0 => 'ROLE_USER'), 'ROLE_MARKETING' => array(0 => 'ROLE_USER'), 'ROLE_CONTACT' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_INFORMATION', 1 => 'ROLE_COMMERCIAL', 2 => 'ROLE_USER', 3 => 'ROLE_MARKETING', 4 => 'ROLE_CONTACT', 5 => 'ROLE_ALLOWED_TO_SWITCH'), 'ROLE_SUPERADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ProductionBundle' => 'Production\\ProductionBundle\\ProductionBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'UserBundle' => 'Production\\UserBundle\\UserBundle',
            ...
            'fos_user.model.user.class' => 'Production\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'fayssal1anouar@gmail.com' => 'admin',
            ),
