...
use Telecontact\UserBundle\Entity\User;
use Telecontact\UserBundle\Form\userType;
use JMS\SecurityExtraBundle\Annotation\Secure;
use Telecontact\telecontactBundle\Pagination\Paginator;
...
class AdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entitiesLength = $em->getRepository('UserBundle:User')->counter();
    ...
    public function ajaxListAction(Request $request)
    {
        ...
        return $this->render('UserBundle:admin:ajax_list.html.twig', array(
                    'entities' => $entities,
    ...
    public function newAction()
    {
        ...
        return $this->render('UserBundle:admin:new.html.twig', array('entity' => $entity, 'form' => $form->createView()));
    }
    ...
    public function showAction($id)
    {
        ...
        return $this->render('UserBundle:admin:show.html.twig', array('entity' => $entity));
    }
    ...
    {
        $form = $this->createForm(new userType(), $entity);
        return $this->render('UserBundle:admin:edit.html.twig', array('entity' => $entity, 'form' => $form->createView()));
    }
    ...
    public function updateAction(Request $request, User $user) {
        ...
        return $this->render('UserBundle:admin:edit.html.twig', array('entity' => $user, 'form' => $form->createView()));
    }
    ...
    {
    	$entity = array();
        return $this->render('UserBundle:admin:new.html.twig', array('entity' => $entity));
    }
    ...
    {
        $role = (in_array($role, array('ADMIN', 'INFORMATION','COMMERCIAL','MARKETING','CONTACT','SUPERADMIN'))) ? 'ROLE_'.$role : 'ROLE_USER';
        $users = $request->get('users');

        $userManager = $this->get('fos_user.user_manager');
        foreach( $users as $id){
            $user = $userManager->findUserBy(array('id' => $id));
            $user->removeRole('ROLE_INFORMATION');
            $user->removeRole('ROLE_ADMIN');
            $user->removeRole('ROLE_COMMERCIAL');
            $user->removeRole('ROLE_MARKETING');
            $user->removeRole('ROLE_CONTACT');
    ...
    public function exportAction()
    {
        ...
        $entities = $em->getRepository('UserBundle:user')->getUsers();
        $response = $this->render('UserBundle:admin:list.csv.twig',array(
                    'entities' => $entities,
                    ));
    ...
    public function editMeAction() {
        ...
        return $this->render('UserBundle:myProfile:edit.html.twig', array(
                    'entity' => $entity,
     ...
     * @Secure(roles="IS_AUTHENTICATED_REMEMBERED")
     */
    public function updateMeAction(Request $request, \Telecontact\UserBundle\Entity\User $entity) {
        $em = $this->getDoctrine()->getManager();
        $isAdmin = $this->get('security.context')->isGranted('ROLE_ADMIN');
        $form = $this->createForm(new UserType(false, $isAdmin), $entity);
        $form->bind($request);
