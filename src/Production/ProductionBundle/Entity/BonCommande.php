 ...
 * @ORM\Entity(repositoryClass="Production\ProductionBundle\Entity\BonCommandeRepository")
 */
class BonCommande
{
    /**
     ...
     * @ORM\OneToMany(targetEntity="BonCommandeLigne", mappedBy="commande")
     */
    private $ligne;
    ...
    /**
     * One Customer has One Cart.
     * @ORM\OneToOne(targetEntity="Welcome", mappedBy="commanderev")
     */
    private $welcomes;
